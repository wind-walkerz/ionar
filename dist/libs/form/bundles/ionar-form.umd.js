(function (global, factory) {
	...
	(factory((global.ionar = global.ionar || {}, global.ionar.form = {}),global.joi,global.utility,global.rxjs.operators,global.ng.common,global.ui,global.ng.core,global.lodash));
}(this, (function (exports,joi,utility,operators,common,ui,core,lodash) { 'use strict';
	...
	***************************************************************************** */
	...
	var IoFormFieldUI_1 = createCommonjsModule(function (module, exports) {
	    ...
	    var IoFormFieldUI = /** @class */ (function (_super) {
	        tslib_es6.__extends(IoFormFieldUI, _super);
	...
	var input_component = createCommonjsModule(function (module, exports) {
	    ...
	    var InputComponent = /** @class */ (function (_super) {
	        tslib_es6.__extends(InputComponent, _super);
	...
	var textarea_component = createCommonjsModule(function (module, exports) {
	    ...
	    var TextareaComponent = /** @class */ (function (_super) {
	        tslib_es6.__extends(TextareaComponent, _super);
	        ///-----------------------------------------------  Life Cycle Hook   -----------------------------------------------///
	...
	var AbstractControl_1 = createCommonjsModule(function (module, exports) {
	     ...
	     */ AbstractControl = /** @class */ (function () {
	        ...
	        Object.defineProperty(AbstractControl.prototype, "path", {
	             ...
	             * @return {?}
	             */ function () {
	                return this.parent ? tslib_es6.__spread(this.parent.path, [this.name]) : [];
	            },
	            enumerable: true,
	            configurable: true
	        });
	        ...
	        Object.defineProperty(AbstractControl.prototype, "options", {
	             ...
	             */ function () {
	                ...
	                if (this.parent && this.parent.options)
	                    parentConfig = tslib_es6.__assign({}, this.parent.options);
	                return tslib_es6.__assign({}, parentConfig, this._initialOptions) || null;
	            },
	            set: /**
	             * @param {?} newConfig
	             * @return {?}
	             */ function (newConfig) {
	                this._options = tslib_es6.__assign({}, this._options, newConfig);
	         ...
	         */
	            function (options, opts) {
	                ...
	                this._initialOptions = tslib_es6.__assign({}, this._initialOptions, options);
	                this._updateControlsOptions(opts.emitEvent !== false);
	            };
	        /**
	...
	var FormControl_1 = createCommonjsModule(function (module, exports) {
	     ...
	     */ FormControl = /** @class */ (function (_super) {
	        tslib_es6.__extends(FormControl, _super);
	        /**
	...
	var FormGroup_1 = createCommonjsModule(function (module, exports) {
	    ...
	    Object.defineProperty(exports, "__esModule", { value: true });
	    var lodash_1 = tslib_es6.__importDefault(lodash);
	    var joi_1 = tslib_es6.__importDefault(joi);
	    /**
	     ...
	     */ FormGroup = /** @class */ (function (_super) {
	        tslib_es6.__extends(FormGroup, _super);
	        /**
	    ...
	    var DynamicFieldDirective = /** @class */ (function () {
	        function DynamicFieldDirective(_resolver, _vcRef) {
	            ...
	            this._updateContext = function () {
	                ...
	                /** @type {?} */
	                var context = tslib_es6.__assign({ name: _this._name, invalid: _this._control.invalid && (_this._control.dirty || _this._control.touched || _this._root.submitted) }, state.props, { template: _this._template }, options);
	...
	var ControlContainer_1 = createCommonjsModule(function (module, exports) {
	    ...
	    var ControlContainer = /** @class */ (function () {
	        ...
	        Object.defineProperty(ControlContainer.prototype, "path", {
	             ...
	             * @return {?}
	             */ function () {
	                return this.parent ? tslib_es6.__spread(this.parent.path, [this.name, 'controls']) : [this.name, 'controls'];
	            },
	            enumerable: true,
	            configurable: true
	        });
	...
	var IoControl_1 = createCommonjsModule(function (module, exports) {
	     ...
	     */ IoControl = /** @class */ (function (_super) {
	        tslib_es6.__extends(IoControl, _super);
	        function IoControl() {
	...
	var formControl_component = createCommonjsModule(function (module, exports) {
	    ...
	    var FormControlComponent = /** @class */ (function (_super) {
	        tslib_es6.__extends(FormControlComponent, _super);
	        ///-----------------------------------------------  Life Cycle Hook   -----------------------------------------------///
	...
	var FormArray_1 = createCommonjsModule(function (module, exports) {
	     ...
	     */ FormArray = /** @class */ (function (_super) {
	        tslib_es6.__extends(FormArray, _super);
	        /**
	...
	var core_component = createCommonjsModule(function (module, exports) {
	    ...
	    var FormComponent = /** @class */ (function (_super) {
	        tslib_es6.__extends(FormComponent, _super);
	...
	var formArray_component = createCommonjsModule(function (module, exports) {
	    ...
	    var FormArrayComponent = /** @class */ (function (_super) {
	        tslib_es6.__extends(FormArrayComponent, _super);
	        ///-----------------------------------------------  Life Cycle Hook   -----------------------------------------------///
	...
	var formGroup_component = createCommonjsModule(function (module, exports) {
	    ...
	    var FormGroupComponent = /** @class */ (function (_super) {
	        tslib_es6.__extends(FormGroupComponent, _super);
	        ///-----------------------------------------------  Life Cycle Hook   -----------------------------------------------///
	...
	var node_component = createCommonjsModule(function (module, exports) {
	    ...
	    var NodeComponent = /** @class */ (function (_super) {
	        tslib_es6.__extends(NodeComponent, _super);
	...
	exports.default = ionarForm$1;
	exports.FormControl = ionarForm_1;
	exports.FormGroup = ionarForm_2;
	exports.FormArray = ionarForm_3;
	exports.AbstractControl = ionarForm_4;
	exports.IonarFormBuilder = ionarForm_5;
	exports.IonarFormModule = ionarForm_6;
