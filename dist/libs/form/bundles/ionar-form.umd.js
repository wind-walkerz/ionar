(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@ionar/joi'), require('@ionar/utility'), require('rxjs/operators'), require('@angular/common'), require('@ionar/ui'), require('@angular/core'), require('lodash')) :
    typeof define === 'function' && define.amd ? define('@ionar/form', ['exports', '@ionar/joi', '@ionar/utility', 'rxjs/operators', '@angular/common', '@ionar/ui', '@angular/core', 'lodash'], factory) :
    (factory((global.ionar = global.ionar || {}, global.ionar.form = {}),global.Joi,global.utility,global.rxjs.operators,global.ng.common,global.ui,global.ng.core,global._));
}(this, (function (exports,Joi,utility,operators,common,ui,i0,_) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var IoFormFieldUI = /** @class */ (function (_super) {
        ...
        function IoFormFieldUI() {
            ...
            _this.enter = new i0.EventEmitter();
            return _this;
        }
        ...
        IoFormFieldUI.propDecorators = {
            ...
            _isFocused: [{ type: i0.HostBinding, args: ['class.focus',] }],
            _isInvalid: [{ type: i0.HostBinding, args: ['class.invalid',] }],
            _isDisabled: [{ type: i0.HostBinding, args: ['class.disabled',] }],
            _isReadonly: [{ type: i0.HostBinding, args: ['class.readonly',] }]
        };
    ...
    var InputComponent = /** @class */ (function (_super) {
        ...
        function InputComponent(cd, _elRef) {
            ...
            _this.onChange = ___default.debounce(function (e) {
                e.stopPropagation();
                /** @type {?} */
    ...
    var UploadComponent = /** @class */ (function (_super) {
        ...
        UploadComponent.prototype.onFileChanged =
             ...
             */
            function (file_list) {
                this.file_list = this.file_list.concat(___default.map(file_list));
    ...
    var DynamicFieldDirective = /** @class */ (function () {
        function DynamicFieldDirective(_resolver, _vcRef) {
            ...
            this._initObservables = function () {
                ___default.forOwn(_this._events, function (value, key) {
            ...
            this._updateContext = function () {
                ...
                ___default.forOwn(context, function (value, key) {
                    if (value !== undefined)
        ...
        DynamicFieldDirective.propDecorators = {
            _name: [{ type: i0.Input, args: ['name',] }],
            _root: [{ type: i0.Input, args: ['root',] }],
            _control: [{ type: i0.Input, args: ['control',] }],
    ...
    var controlNameBinding = {
        provide: IoControl,
        useExisting: i0.forwardRef(function () { return FormControlComponent; })
    };
    var FormControlComponent = /** @class */ (function (_super) {
        ...
        Object.defineProperty(FormControlComponent.prototype, "controlTemplateDir", {
            ...
            function () {
                ...
                if (parent.ioTemplateDirList)
                    return ___default.find(parent.ioTemplateDirList.toArray(), ['name', this.name])
                        || ___default.find(parent.ioTemplateDirList.toArray(), ['component', state.component]);
            },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(FormControlComponent.prototype, "hiddenStyle", {
             ...
             * @return {?}
             */ function () {
                return ___default.get(this.control.options, ['hidden']);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(FormControlComponent.prototype, "isHideLabel", {
             ...
             * @return {?}
             */ function () {
                return ___default.get(this.control.options, ['hideLabel']);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(FormControlComponent.prototype, "isHideFeedback", {
             ...
             * @return {?}
             */ function () {
                return ___default.get(this.control.options, ['hideFeedback']);
            },
            enumerable: true,
            configurable: true
        });
        ...
        /** @nocollapse */
        FormControlComponent.ctorParameters = function () {
            return [
        ...
        FormControlComponent.propDecorators = {
            _ioTemplateDir: [{ type: i0.ContentChild, args: [ui.IonarTemplateDirective,] }],
            attribute: [{ type: i0.HostBinding, args: ['attr.id',] }],
            hiddenStyle: [{ type: i0.HostBinding, args: ['class.hidden',] }],
            isHideLabel: [{ type: i0.HostBinding, args: ['class.hideLabel',] }],
            isHideFeedback: [{ type: i0.HostBinding, args: ['class.hideFeedback',] }]
        };
    ...
    var FieldComponent = /** @class */ (function () {
        ...
        FieldComponent.ctorParameters = function () {
            return [
                { type: i0.ChangeDetectorRef },
                { type: FormControlComponent, decorators: [{ type: i0.Optional }, { type: i0.Host }, { type: i0.SkipSelf }] }
            ];
        };
    ...
    var LabelComponent = /** @class */ (function () {
        ...
        Object.defineProperty(LabelComponent.prototype, "label", {
             ...
             */ function () {
                ...
                return (props && props.label) ? props.label : ___default.startCase(this._parent.name);
            },
            enumerable: true,
            configurable: true
        });
     ...
     */ AbstractControl = /** @class */ (function () {
        ...
        function AbstractControl(state, _options) {
            ...
            this._isNotExcluded = function (c) {
                return !___default.get(c.options, 'excluded') && !(___default.has(_this.options, ['nullExclusion']) && !c.value);
            };
        ...
        Object.defineProperty(AbstractControl.prototype, "schema", {
             ...
             */ function () {
                if (this.parent && this.parent.schema) {
                    /** @type {?} */
                    var extractChild = ___default.find(this.parent.schema['_inner'].children, ['key', this.name]);
         ...
         */
            function () {
                var _this = this;
                (( /** @type {?} */(this))).runAsyncValidator = ___default.debounce(function (emitEvent) {
     ...
     */ FormControl = /** @class */ (function (_super) {
         ...
         */
            function (value, options) {
                ...
                if (___default.has(this.options, ['submitOnChange'])) {
     ...
     */ FormGroup = /** @class */ (function (_super) {
         ...
         */
            function (name) {
                (( /** @type {?} */(this))).controls = ( /** @type {?} */(___default.omit(this.controls, [name])));
                this.updateValueAndValidity();
            };
        /**
         ...
         */
            function (formValue, options) {
                ...
                ___default.forOwn(formValue, function (value, name) {
         ...
         */
            function (value, options) {
                ...
                ___default.forOwn(this.controls, function (c, name) {
         ...
         */
            function (path) {
                if (!path)
                    return null;
                return ___default.get(this.controls, path) || null;
            };
        /**
         * @param {?=} instant
         * @return {?}
         ...
         */
            function (controlConfig) {
                var _this = this;
                (( /** @type {?} */(this.controls))) = {};
                ___default.forOwn(controlConfig, function (c, name) {
                    c.setParent(_this);
         ...
         */
            function (name) {
                if (!___default.keys(this.controls).length) {
         ...
         */
            function () {
                return ___default.every(___default.values(this.controls), function (c) { return c.disabled; });
            };
        /** @internal */
        /**
         * \@internal
         ...
         */
            function (status) {
                return !!___default.find(___default.values(this.controls), ['status', status]);
            };
        return FormGroup;
    }(AbstractControl));
     ...
     */ FormArray = /** @class */ (function (_super) {
         ...
         */
            function (options) {
                ...
                ___default.each(this.controls, function (c) {
                    c.clear({ onlySelf: true, emitEvent: options.emitEvent });
                });
                this.updateValueAndValidity(options);
                if (___default.has(this.options, ['submitOnChange'])) {
         ...
         */
            function (controlConfig) {
                var _this = this;
                (( /** @type {?} */(this.controls))) = [];
                ___default.each(controlConfig, function (c, index) {
                    c.setParent(_this);
    ...
    var FormService = /** @class */ (function () {
        function FormService() {
            ...
            this.mergeControls = function (controls, parent_name) {
                ...
                var result = [];
                //
                if (___default.isPlainObject(controls)) {
                    ___default.forOwn(controls, function (c, name) {
                        /** @type {?} */
                ...
                if (___default.isArray(controls)) {
                    ___default.each(controls, function (c, index) {
                        if (c instanceof FormControl)
            ...
            this.convertToFormData = function (data) {
                ...
                ___default.forOwn(data, function (value, key) {
                    if (___default.isArray(value)) {
                        ___default.each(value, function (file) { return form.append(key + "[]", file, file.name); });
                    }
                    else
    ...
    var formProvider = {
        ...
        useExisting: i0.forwardRef(function () { return FormComponent; })
    };
    var FormComponent = /** @class */ (function (_super) {
        ...
        FormComponent.propDecorators = {
            ...
            _contentVcRef: [{ type: i0.ViewChild, args: ['contentVc', { read: i0.ViewContainerRef },] }],
            controlTemplate: [{ type: i0.ViewChild, args: ['controlTemplate',] }],
            ioTemplateDirList: [{ type: i0.ContentChildren, args: [ui.IonarTemplateDirective,] }]
        };
    ...
    var formArrayProvider = {
        provide: ControlContainer,
        useExisting: i0.forwardRef(function () { return FormArrayComponent; })
    };
    var FormArrayComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        FormArrayComponent.ctorParameters = function () {
            return [
                { type: ControlContainer, decorators: [{ type: i0.Optional }, { type: i0.Host }, { type: i0.SkipSelf }] },
                { type: i0.ElementRef },
                { type: i0.ChangeDetectorRef }
        ...
        FormArrayComponent.propDecorators = {
            attribute: [{ type: i0.HostBinding, args: ['attr.id',] }],
            _controlContainers: [{ type: i0.ContentChildren, args: [ControlContainer,] }]
        };
    ...
    var formGroupProvider = {
        provide: ControlContainer,
        useExisting: i0.forwardRef(function () { return FormGroupComponent; })
    };
    var FormGroupComponent = /** @class */ (function (_super) {
        ...
        FormGroupComponent.propDecorators = {
            attribute: [{ type: i0.HostBinding, args: ['attr.id',] }],
            _controlContainerList: [{ type: i0.ContentChildren, args: [ControlContainer,] }],
            _ioControlList: [{ type: i0.ContentChildren, args: [IoControl,] }]
        };
    ...
    var SelectComponent = /** @class */ (function () {
        ...
        function SelectComponent(eRef) {
            ...
            this.onChange = function (option) {
                _this.options = ___default.map(_this.options, function (item) {
                    item.selected = ___default.isEqual(item, option);
         ...
         */
            function () {
                if (this.value) {
                    this.selected_option = ___default.find(this.options, ['value', this.value.toString()]);
                }
            };
        ///-----------------------------------------------  Host   -----------------------------------------------///
        ///-----------------------------------------------  Host   -----------------------------------------------///
    ...
    var IonarFormBuilder = /** @class */ (function () {
         ...
         */
            function (controlsConfig) {
                ...
                /** @type {?} */
                var controls;
                if (___default.isPlainObject(controlsConfig)) {
                    controls = {};
                    ___default.forOwn(controlsConfig, function (c, name) {
                        (( /** @type {?} */(controls)))[name] = _this._createControl(c);
                    });
                }
                else {
                    controls = [];
                    ___default.each(controlsConfig, function (c) {
    ...
    exports.ɵk = FeedbackComponent;
    exports.ɵf = FieldComponent;
    exports.ɵj = LabelComponent;
    exports.ɵm = FormArrayComponent;
    exports.ɵl = formArrayProvider;
    exports.ɵh = FormControlComponent;
    exports.ɵg = controlNameBinding;
    exports.ɵo = FormGroupComponent;
    exports.ɵn = formGroupProvider;
    exports.ɵc = FormComponent;
    exports.ɵb = formProvider;
    exports.ɵa = CoreModule;
    exports.ɵp = DynamicFieldDirective;
    exports.ɵq = SubmitDirective;
    exports.ɵd = ControlContainer;
    exports.ɵi = IoControl;
    exports.ɵe = FormService;
    exports.ɵw = CheckboxComponent;
    exports.ɵv = CheckboxModule;
    exports.ɵt = InputComponent;
    exports.ɵs = InputModule;
    exports.ɵbj = MenuComponent;
    exports.ɵbi = MenuModule;
    exports.ɵbd = ControlComponent;
    exports.ɵbe = MenuComponent$1;
    exports.ɵbf = OptionComponent;
    exports.ɵbc = SelectComponent;
    exports.ɵbb = SelectModule;
    exports.ɵbh = TextareaComponent;
    exports.ɵbg = TextareaModule;
    exports.ɵbm = NodeComponent;
    exports.ɵbl = TreeComponent;
    exports.ɵbk = TreeModule;
    exports.ɵz = ClickComponent;
    exports.ɵba = DropComponent;
    exports.ɵy = UploadComponent;
    exports.ɵx = UploadModule;
    exports.ɵu = IoFormFieldUI;
    exports.ɵr = FormUiModule;
