...
export declare class IonarFormBuilder {
     ...
     *
     */
    group: (state: FormGroupState, options?: AbstractControlOptions) => FormGroup;
    /**
     * @description
     ...
     * functions.
     */
    array: (state: AbstractControl[] | FormControlState[], options?: AbstractControlOptions) => FormArray;
    /** @internal */
