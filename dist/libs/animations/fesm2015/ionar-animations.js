...
/** @type {?} */
const bounce = animation(animate('{{ timing }}ms {{ delay }}ms', keyframes([
    style({
...
/** @type {?} */
const bounce_trigger = trigger('bounce', [
    transition('* => *', [
        useAnimation(bounce)
    ])
]);
...
/** @type {?} */
const flash_trigger = trigger('flash', [
    transition('* => *', [
        useAnimation(flash)
    ])
]);
...
/** @type {?} */
const pulse_trigger = trigger('pulse', [
    transition('* => *', [
        useAnimation(pulse)
    ])
]);
...
/** @type {?} */
const rubber_band_trigger = trigger('rubber_band', [
    transition('* => *', [
...
/** @type {?} */
const rotate_trigger = trigger('rotate', [
    state('default', style({})),
...
/** @type {?} */
const bounce_in_trigger = trigger('bounce_in', [
    transition('* => *', [
 ...
 */
/** @type {?} */
const bounce_in_down = animation([
    animate('{{ timing }}ms {{ delay }}ms', keyframes([
        style({
            animationTimingFunction: `cubic-bezier(0.215, 0.61, 0.355, 1)`,
...
/** @type {?} */
const bounce_in_down_trigger = trigger('bounce_in_down', [
    transition('* => *', [
...
/** @type {?} */
const bounce_out_up_trigger = trigger('bounce_out_up', [
    transition('* => *', [
...
/** @type {?} */
const fade_in_down_trigger = trigger('fade_in_down', [
    transition('* => *', [
...
/** @type {?} */
const fade_out_up_trigger = trigger('fade_out_up', [
    transition('* => *', [
 ...
 */
/** @type {?} */
const slideInLeftAnimation = animation([
    animate('{{ timing }}ms {{ delay }}ms', keyframes([
        style({
